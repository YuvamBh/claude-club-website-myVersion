...
export default function TeamPage() {
  ...
  return (
    <div
      className="min-h-[100dvh] max-h-[100dvh] relative overflow-y-auto"
              ...
              {contributors.map((contrib) => (
                <motion.div key={contrib.url} variants={cardVariants}>
                  <a
                    ...
                    className="flex flex-col items-center text-center gap-3 rounded-2xl border p-6 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md"
                    style={{ borderColor: "var(--theme-card-border)", background: "var(--theme-card-bg)" }}
                  >
                    <div className="w-14 h-14 rounded-full overflow-hidden border-2" style={{ borderColor: "var(--theme-card-border)" }}>
                    ...
                    <div className="flex flex-col items-center gap-1">
                      ...
                      <svg className="w-4 h-4" style={{ color: "var(--theme-text-accent)" }} fill="currentColor" viewBox="0 0 24 24">
