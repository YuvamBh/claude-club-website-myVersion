...
import { requireAuth } from "@/lib/hackathon/rbac";
import {
  getActiveHackathon,
  getUserApplication,
  getUserTeam,
  getTeamSubmission,
} from "@/lib/hackathon/queries";
import {
  ClipboardList,
  Users,
  Send,
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Section
          title="Your Team"
          action={team ? { label: "Manage", href: "/hackathon/team" } : undefined}
        >
          {team ? (
            <div>
        ...
        <Section title="What&apos;s Next">
          <div className="space-y-2">
            ...
            {!team && (
              <ActionItem label="Create or join a team" href="/hackathon/team" priority="medium" />
            )}
